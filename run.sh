...
cd pupilfirst
npm install
npx bsb -make-world -clean-world 2>> ../../results/pupilfirst/avant.stderr 1>> ../../results/pupilfirst/avant.stdout
...
esy
esy bsb -make-world -clean-world 2>> ../../results/pupilfirst/melange.stderr 1>> ../../results/pupilfirst/melange.stdout
